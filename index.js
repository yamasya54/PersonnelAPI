...
/* ------------------------------------------------------- */
// Required Modules://!1. işlem modüller

// envVariables to process.env:
require('dotenv').config()
const PORT = process.env?.PORT || 8000

// asyncErrors to errorHandler://* burada yapmazsam her conroller sayfasının tepesinde yazacaktım
require('express-async-errors')

/* ------------------------------------------------------- */
// Configrations://!2.işlem veri tabana bağlanmak
...
/* ------------------------------------------------------- */
// Middlewares://! 3. işlem mid. ekleyelim
...
// console.log(morgan)
// app.use(morgan('combined'))//*en detaylı combined
...
// Accept JSON:
app.use(express.json()) //! olmazsa olmaz.gelen json veriyi pars etmek için ve objeye çevirmek için
...
// Login/Logout Control Middleware//!bu cookide saklanandı alttaki jwt midverisi  sonrası gerek kalmadı
...
//* Moved -> middlewares/authentication.js ---->  login olup olmadığını bana ispatlıyor
//! midwer klasöründe authenticationa taşıdım yoruma aldım bu nedenle
...
//? /departments istekleri burada yönetilir.
